(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // var sliderList = document.querySelector('.slider__item--after'); /** .slider__list*/
    var photoBefore = document.querySelector('.slider__box--before'); /**.slider__slide--before */
    var sliderControlToggle = document.querySelector('.slider-control__toggle');
